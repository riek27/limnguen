  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok && data.success) {
        localStorage.setItem('lnf-admin-auth', 'true');
  ...
  return (
    <div
      style={{
        ...
        background: 'linear-gradient(135deg, #0A0F1F 0%, #102A43 55%, #1B3A5C 100%)',
    ...
    >
      ...
      <div
        style={{
          ...
          height: '450px',
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(212,161,42,0.25) 0%, transparent 70%)',
          pointerEvents: 'none',
        }}
      />
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          <div
            style={{
              ...
              height: '72px',
              borderRadius: '18px',
              background: 'linear-gradient(135deg, #0D9488, #0A0F1F)',
              display: 'inline-flex',
              alignItems: 'center',
              justifyContent: 'center',
              marginBottom: '18px',
              boxShadow: '0 12px 32px rgba(13,148,136,0.4)',
              border: '1px solid rgba(245,214,123,0.25)',
            }}
          >
            <img
          ...
          <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.88rem', marginTop: '14px' }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* WARNING BANNER (attempts remaining) */}
          {warning && !isBlocked && (
            <div
              style={{
          ...
          <button
            ...
            style={{
              ...
              color: isBlocked ? 'rgba(255,255,255,0.5)' : '#0A0F1F',
              border: 'none',
              borderRadius: '12px',
              fontSize: '1rem',
              fontWeight: 700,
              ...
              boxShadow: isBlocked
                ? 'none'
                : '0 10px 24px rgba(212,161,42,0.35)',
              display: 'inline-flex',
              alignItems: 'center',
              justifyContent: 'center',
              gap: '8px',
            ...
            onMouseEnter={(e) => {
              if (!loading && !isBlocked) e.currentTarget.style.transform = 'translateY(-2px)';
            }}
            onMouseLeave={(e) => {
          ...
          >
            {isBlocked ? (
              <>
                <i className="fas fa-lock" /> Blocked ({formatCountdown(countdown)})
              </>
            ) : loading ? (
              <>
